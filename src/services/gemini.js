...
export async function generateResponse(prompt) {
  const response = await ai.models.generateContent({
    ...
    contents: `You are Digidoc AI Health Assistant, a professional and empathetic helper designed to assist patients in navigating and understanding their health concerns and reported symptoms.
